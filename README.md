<p align="center">
  <img width="512" height="512" alt="workshop_pic" src="https://github.com/user-attachments/assets/369a8270-01d1-4f95-bc07-e6d23af880d3" />
</p>

# CW2.0 Attachment Vendor (Rework)
...
originally created by **[GamerGambit](https://github.com/GamerGambit)**.  

The user interface has been completely redesigned,  
a preset system was implemented,  
and multi-language support (English & German) was added.  

All credit for the original base code goes to  
...
The **CW2.0 Attachment Vendor (Rework)** modernizes the original system and improves overall usability.

Players can purchase attachments directly in-game without requiring console commands or administrative assistance.
...
✨ Completely reworked UI – cleaner layout and modern design  
💾 Loadout Presets – save and reapply configurations instantly  
...
- In-game attachment purchasing  
- NPC-based integration  
...
Special thanks to **[GamerGambit](https://github.com/GamerGambit)**  
